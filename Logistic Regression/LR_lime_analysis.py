...
def train_and_test_from_json(json_file, drop_features=None):
    ...
    for i, (dataset_name, ds) in enumerate(datasets.items(), start=1):
        ...
        # Use absolute value of coefficients as feature importance proxy
...
# -----------------------------
def plot_lime_dual(exp_pred, exp_actual, feature_names, dataset_num, pred_label, actual_label, save_dir="Logistic Regression/lime plots"):
...
if __name__ == "__main__":
    ...
    for r in results:
        ...
        if y_pred[0] != y_test[0]:
            ...
            # Actual explanation: LIME needs a predict function; simulate one-hot for actual
